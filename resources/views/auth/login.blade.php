  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .logo-text {
      ...
      color: #0C1D3B; letter-spacing: -.5px;
    }
    ...
    .card-title {
      ...
      color: #0C1D3B; margin-bottom: 4px;
    }
    .card-sub {
      text-align: center;
    ...
    .form-row-extra input[type="checkbox"] {
      accent-color: #1A56DB;
...
<body>
  ...
  <div class="login-card">
    ...
    {{-- Alert error (dari Google login gagal, dll) --}}
    @if (session('error'))
      <div class="alert-error">{{ session('error') }}</div>
    @endif

    {{-- Alert warning (misal belum lengkapi profile) --}}
    @if (session('warning'))
