...
<style>
    ...
    .step-num { width: 30px; height: 30px; border-radius: 50%; display: flex; align-items: center;
                justify-content: center; font-size: 12px; font-weight: 700; background: var(--gray-200); color: var(--gray-500); }
    ...
    /* summary card */
    .card-title { font-size: 15px; font-weight: 700; color: var(--blue-900); margin-bottom: 18px;
    ...
    .period-badge { margin-top: 18px; background: var(--blue-50); border: 1px solid var(--blue-100);
                    color: var(--blue-700); border-radius: 8px; padding: 10px 14px; font-size: 13px;
                    font-weight: 600; display: flex; align-items: center; gap: 8px; }

    /* time card */
    .time-title { font-size: 15px; font-weight: 700; color: var(--blue-900); margin-bottom: 16px;
                  display: flex; align-items: center; gap: 8px; }
    .time-row { display: flex; align-items: center; gap: 8px; margin-bottom: 10px; }
    .time-row input[type="time"] { flex: 1; border: 1.5px solid var(--gray-200); border-radius: 10px;
    ...
    .btn-remove { width: 34px; height: 34px; border-radius: 8px; background: var(--red-100); color: var(--red-600);
                  border: none; cursor: pointer; display: inline-flex; align-items: center; justify-content: center;
                  font-size: 13px; flex-shrink: 0; transition: opacity .2s; }
    .btn-remove:hover { opacity: .75; }
    .btn-add-time { display: inline-flex; align-items: center; gap: 7px; background: var(--blue-50);
                    border: 1.5px dashed var(--blue-600); color: var(--blue-600); padding: 8px 16px;
                    border-radius: 10px; font-size: 13px; font-weight: 600; cursor: pointer;
                    margin-bottom: 16px; transition: background .2s; }
    .btn-add-time:hover { background: var(--blue-100); }
    .btn-save { width: 100%; padding: 12px; border: none; background: var(--blue-600); color: #fff;
                border-radius: 10px; font-weight: 700; font-size: 15px; cursor: pointer; transition: background .2s; }
    .btn-save:hover { background: var(--blue-700); }
    .skip { display: block; text-align: center; margin-top: 14px; font-size: 13px; color: var(--gray-500);
            text-decoration: none; transition: color .2s; }
    .skip:hover { color: var(--blue-600); }
    ...
    <div class="layout">
        ...
        <div class="card">
            ...
            <div class="info-row">
                ...
                <div class="value">
                    <i class="fas fa-pills me-1" style="color:var(--blue-600)"></i>
                    {{ $jadwal->nama_obat }}
                </div>
            </div>
            @if($jadwal->deskripsi)
