...
<div class="wrap">
    <a href="{{ route('dokter.jadwal.index') }}" class="back">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="info-row">
                ...
                <span class="value">{{ $jadwal->user->name }}</span>
            </div>
            <div class="info-row">
    ...
    <div class="card">
        <div class="card-body">
            <div class="catatan-box">
                <strong><i class="fa-solid fa-note-sticky"></i> Catatan:</strong><br>
                {{ $jadwal->deskripsi }}
            </div>
        </div>
    </div>
    ...
    <div style="display:flex; justify-content:flex-end;">
        <a href="{{ route('dokter.jadwal.edit', $jadwal->id) }}" class="btn-edit">
